...
{
    public class EFVnPayService : IVnPayService
    {
        private readonly IConfiguration _config;

        public EFVnPayService(IConfiguration configuration)
        {
            _config = configuration;
        }

        public string CreatePaymentUrl(VnPaymentResquestModel model, HttpContext context)
        {
